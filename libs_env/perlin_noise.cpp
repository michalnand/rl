...
PerlinNoise::PerlinNoise(float amp_decay, int octaves, unsigned int seed)
{
  init(amp_decay, octaves, seed);
}
...
void PerlinNoise::init(float amp_decay, int octaves, unsigned int seed)
{
  this->amp_decay = amp_decay;
